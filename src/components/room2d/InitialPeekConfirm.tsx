  ...
  return (
    <motion.button
      ...
      className={`fixed bottom-10 right-10 z-40 px-7 py-4 rounded-2xl font-extrabold text-lg shadow-2xl transition-colors ${
        confirmed
          ? 'bg-bate-paper text-bate-ink cursor-default'
          : 'bg-gradient-to-br from-bate-green via-emerald-400 to-emerald-600 text-white shadow-[0_0_24px_rgba(6,214,160,0.6)]'
      }`}
    >
